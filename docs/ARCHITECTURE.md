...
## Core Components
- `MainActivity`
  - Owns screen initialization, custom top bar (title, bills-days calendar, recalculate), pond list, transactions list, month navigation, transfer summaries, dialogs, bills-period filter, and rollover triggering.
