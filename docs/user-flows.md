...
5. Gallery pick (add/edit receipt only) uses `GetContent` so the photo gallery opens, not Files. Import still copies into **Pictures/Mountain Money** and persists that album URI. Preview/recovery never open a picker.
