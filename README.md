...
- 2026-06-17: **Pond header single row:** Merged pond title, selected count, select/unselect, reorder/done, collapse, and add into one icon toolbar row (`content_main.xml`, `MainActivity`); auto-exits reorder on collapse. Local `./gradlew` still requires JDK **8–15**.
